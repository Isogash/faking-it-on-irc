...
/**
 * Local helper function to convert seconds into a nice timestamp.
 * @param {Number} secs - Seconds to convert into a timestamp string.
 * @return {String} - Converted timestamp string.
 */
function mmss(secs) {
...
/**
 * Creates a new game session object.
 * @constructor
 * @param {Object} pubfunc - Callback that handles public messages.
 * @param {Object} pvtfunc - Callback that handles direct player messages.
 */
fakeit_game.Game = function(pubfunc, pvtfunc) {
    ...
    game.showRules = function(player) {
        game.message(player,
            ...
            "one who chosen at random (who wasn\'t the topic setter.)"
        );
        ...
        game.message(player, "Players have 5 minutes to do their detecting " +
